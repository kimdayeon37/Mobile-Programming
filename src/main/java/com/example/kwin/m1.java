...
public class m1 extends AppCompatActivity {
    ...
    public void showNoti () {
        ...
        //알림창 메시지
        builder.setContentText("멘티님의 대화신청이 도착했습니다!");
        //알림창 아이콘
    ...
    private void showDialog() {
        AlertDialog.Builder msgBuilder = new AlertDialog.Builder(m1.this)
                .setTitle("멘토님에게").setMessage("대화 신청을 하시겠습니까?")
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(m1.this, "멘토님에게 1:1 대화신청 알람이 전송되었습니다", Toast.LENGTH_SHORT).show();
                        showNoti(); }
                ...
                .setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(m1.this, "취소하였습니다", Toast.LENGTH_SHORT).show();
                    }
                });
