...
public class Bdd extends AppCompatActivity {
        ...
        btnQuit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(username.equals("")||usercol.equals("")||userma.equals("")||usergr.equals("")||userint.equals("")||userno.equals("")){
                    AlertDialog.Builder dialog=new AlertDialog.Builder(Bdd.this);
    ...
    private void showDialog() {
        AlertDialog.Builder msgBuilder = new AlertDialog.Builder(Bdd.this)
                .setTitle("멘티 추가").setMessage("멘티를 등록 하시겠습니까?")
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Bdd.this, "멘티 등록 완료", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(getApplicationContext(),
                                    BddmainActivity.class);
                ...
                .setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(Bdd.this, "취소하였습니다", Toast.LENGTH_SHORT).show();
                    }
                });
