...
public class m2 extends AppCompatActivity {
    ...
    private void showDialog() {
        AlertDialog.Builder msgBuilder = new AlertDialog.Builder(m2.this)
                .setTitle("멘토님에게").setMessage("대화 신청을 하시겠습니까?")
                .setPositiveButton("네", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(m2.this, "멘토님에게 1:1 대화신청 알람이 전송되었습니다", Toast.LENGTH_SHORT).show();
                        showNoti(); }
                ...
                .setNegativeButton("취소", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(m2.this, "취소하였습니다", Toast.LENGTH_SHORT).show();
                    }
                });
